# SetupFX Contracts — Phase 1 Vault

Foundry workspace for the **SetupFXVaultV1** custody vault.
...
```
backend/contracts/
├── src/SetupFXVaultV1.sol       # the contract
├── test/SetupFXVaultV1.t.sol    # Foundry unit + fuzz + invariant tests
...
forge verify-contract <DEPLOYED_ADDRESS> \
  src/SetupFXVaultV1.sol:SetupFXVaultV1 \
  --chain-id 97 \
  --watch \
