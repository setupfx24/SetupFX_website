  ...
  return (
    <section className="bg-white">
      <div className="w-full mx-auto px-6 md:px-10 lg:px-16 py-20 md:py-28 text-center">
        <h2 className={`${TEXT_DISPLAY} text-indigo-500 leading-none`}>Follow us</h2>
        <div className="mt-10 flex flex-wrap justify-center gap-3 md:gap-4">
          {SOCIALS.map(({ Icon, label }) => (
            <a
              ...
              href="#"
              aria-label={label}
              className="w-10 h-10 md:w-11 md:h-11 rounded-full bg-gray-900 text-white flex items-center justify-center hover:bg-indigo-500 transition-colors"
            >
