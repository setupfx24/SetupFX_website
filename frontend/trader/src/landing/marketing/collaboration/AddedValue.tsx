...
function GaugeIllustration() {
  return (
    <div className="relative w-full aspect-[5/3] flex items-center justify-center">
      <div
        className="relative w-44 h-24 md:w-56 md:h-32 border-[14px] md:border-[18px] border-[#1074FE] rounded-t-full border-b-0"
        aria-hidden="true"
      >
        <span
          className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#1074FE] text-white flex items-center justify-center"
          aria-hidden="true"
        >
  ...
  return (
    <div className="relative w-full aspect-[5/3] flex items-center justify-center">
      ...
      >
        ...
        />
        <circle cx="75" cy="30" r="3" fill="#1074FE" />
      </svg>
      <span className="absolute left-[36%] top-1 text-[11px] font-bold text-[#1074FE] bg-[#1074FE]/15 px-2 py-0.5 rounded">
        + 6%
      </span>
    </div>
  )
