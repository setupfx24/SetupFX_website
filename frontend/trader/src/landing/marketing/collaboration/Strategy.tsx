  ...
  return (
    <div className="relative bg-gray-50 rounded-3xl w-full aspect-square max-w-md mx-auto flex items-center justify-center overflow-hidden">
      <div className="relative w-48 h-48 md:w-60 md:h-60">
        <div
          className="absolute inset-0 rounded-full border-[14px] md:border-[18px] border-indigo-500"
          style={{
        ...
        />
        <div
          className="absolute inset-0 rounded-full border-[14px] md:border-[18px] border-indigo-500/30"
          aria-hidden="true"
        />
        <div className="absolute inset-6 bg-white rounded-md shadow-md flex flex-col gap-1.5 p-3 md:p-4">
          ...
          <span className="h-2 rounded bg-indigo-500/40 w-2/3" />
        </div>
      </div>
      <span
        className="absolute top-10 right-10 w-3 h-3 rounded-full bg-indigo-500"
        aria-hidden="true"
      />
    </div>
  )
