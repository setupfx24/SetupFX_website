          ...
          <div className={`inline-flex items-center gap-2 mb-5 ${isCenter ? 'justify-center' : ''}`}>
            <span
              ...
              style={{
                ...
                background:
                  'linear-gradient(180deg, rgba(16,116,254,0.18), rgba(16,116,254,0.04))',
            ...
            >
              <span
                ...
                style={{
                  ...
                  boxShadow: '0 0 8px rgba(16,116,254,0.7)',
                }}
              />
              {badge}
            </span>
      ...
      <ScrollReveal variant="fadeUp" delay={0.15}>
        <div className={`flex ${isCenter ? 'justify-center' : ''} mb-5`}>
          <div className="flex items-center gap-2">
            <span className="w-8 h-px" style={{ background: 'rgba(16,116,254,0.6)' }} />
            <span
              className="w-1.5 h-1.5 rounded-full"
