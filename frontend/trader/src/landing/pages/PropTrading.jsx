    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="section-padding hero-banner relative overflow-hidden">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(16,116,254,0.18), transparent 70%)',
          }}
        />
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="mt-6 text-xl text-text-secondary max-w-3xl mx-auto">
              ...
              The SetupFX Prop Program is launching in <span className="text-primary-accent font-semibold">Q3 2026</span>.
        ...
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            ...
            <p className="text-text-secondary max-w-2xl mx-auto mb-8">
              Open a SetupFX account today — your trading history counts toward your early-access tier when the Prop Program goes live.
            </p>
