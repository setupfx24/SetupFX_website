...
const Blog = () => {
  ...
  const posts = [
    ...
    },
    {
      ...
      category: 'Platforms',
      date: 'March 5, 2025',
      excerpt: 'Learn how to follow expert traders and automatically replicate their strategies on SetupFX.',
      body: 'Copy trading lets you mirror the trades of experienced traders automatically — when they open a position, the same trade fires in your account, scaled to your allocated capital. On SetupFX, browse the leader board sorted by long-term return, max drawdown, and win rate. Allocate a portion of your capital (never all of it) and choose 3–5 leaders with different strategies (trend, scalping, swing) for diversification. Review monthly: keep what works, drop what does not. Copy trading is not passive income — it is active portfolio management of human strategies.',
      image: '💻'
    },
    {
