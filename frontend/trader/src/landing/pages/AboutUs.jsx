    ...
    <div className="min-h-screen pt-20">
      <section className="section-padding hero-banner relative overflow-hidden" style={{ background: '#050707' }}>
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(60% 50% at 50% 0%, rgba(16,116,254,0.18) 0%, transparent 60%), ' +
        ...
        <div className="container-custom text-center relative z-10">
          <ScrollReveal variant="fadeUp">
            ...
            >
              <span className="size-1.5 rounded-full" style={{ background: '#1074FE' }} />
              <span className="text-[11px] uppercase tracking-[0.22em] font-semibold text-white">About SetupFX</span>
            </span>
            <h1
          ...
          <ScrollReveal variant="fadeUp">
            <div className="max-w-4xl mx-auto mb-16">
              <p className="text-lg text-text-secondary leading-relaxed mb-6">
                Founded in 2010, SetupFX is a globally regulated forex and CFD broker headquartered at Office 23US, 18 Young St, UNIT LGE 1/1, Edinburgh EH2 4JB, Scotland, and a decentralized exchange offering on-chain insured trades and non-custodial wallet trading. With over 500,000 clients across 150+ countries, we've built our reputation on transparency, speed, and trust.
              </p>
              <p className="text-lg text-text-secondary leading-relaxed">
                Our mission is to democratize access to global financial markets by providing cutting-edge technology, competitive pricing, and world-class support. Whether you're a beginner taking your first steps in trading or a seasoned professional, SetupFX provides the tools, platforms, and expertise you need to succeed.
              </p>
            </div>
          </ScrollReveal>
      ...
      <section className="section-padding bg-gradient-hero">
        <div className="container-custom text-center">
          <ScrollReveal variant="fadeUp">
            <h2 className="text-4xl font-bold text-white mb-6">Join the SetupFX Family</h2>
