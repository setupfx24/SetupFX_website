...
const steps = [
  ...
  { icon: LayoutDashboard,  title: 'Create Trading Account',  desc: 'Choose your platform â€” SetupFX App or MT5.' },
        ...
        <div className="mt-12 md:mt-16 -mx-6 md:mx-0 px-6 md:px-0 overflow-x-auto md:overflow-visible">
          <div className="relative grid grid-flow-col md:grid-flow-row auto-cols-[240px] md:auto-cols-auto md:grid-cols-7 gap-4 md:gap-3 min-w-max md:min-w-0">
            <div
              ...
              style={{
                backgroundImage:
                  'repeating-linear-gradient(90deg, rgba(16,116,254,0.5) 0 6px, transparent 6px 14px)',
              }}
            />
            {steps.map((s, i) => {
              const Icon = s.icon
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    <div
                      ...
                      style={{
                        ...
                        border: '1px solid rgba(16,116,254,0.28)',
                        boxShadow:
                          '0 1px 0 rgba(255,255,255,0.06) inset, 0 12px 32px -16px rgba(16,116,254,0.32)',
                      }}
                    >
                      ...
                      <span
                        ...
                        style={{
                          ...
                          color: '#1a1408',
                          boxShadow: '0 6px 16px -6px rgba(16,116,254,0.55)',
                        }}
                      >
                        {i + 1}
                      </span>
