        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <ScrollReveal variant="fadeUp">
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'rgba(16,116,254,0.05)',
                  border: '1px solid rgba(16,116,254,0.22)',
                }}
              >
          ...
          <ScrollReveal variant="fadeUp" delay={0.1}>
            <div
              ...
              style={{
                background:
                  'linear-gradient(160deg, rgba(16,116,254,0.06) 0%, var(--fx-bg-elev-2) 60%)',
                border: '1px solid rgba(16,116,254,0.22)',
              }}
            >
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-4 my-1 ml-[44px] pl-3"
                     style={{ borderLeft: '2px dashed rgba(16,116,254,0.35)' }}>
                  {/* Day branch */}
                  <div
      ...
      <div className="flex flex-col items-center">
        ...
        {showLine && (
          <div
            ...
            style={{ background: 'rgba(16,116,254,0.35)' }}
          />
        )}
      </div>
