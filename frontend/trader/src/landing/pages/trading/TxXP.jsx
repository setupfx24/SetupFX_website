                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      top: 22,
                      background:
                        'linear-gradient(90deg, rgba(16,116,254,0.18) 0%, rgba(16,116,254,0.65) 50%, rgba(16,116,254,1) 100%)',
                      boxShadow: '0 0 18px rgba(16,116,254,0.45)',
                    }}
                  />
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: '0 6px 18px rgba(16,116,254,0.45)',
                    }}
                  >
                    XP
                  </div>
                          ...
                          <div
                            ...
                            style={{
                              background: isLast
                                ...
                                : 'var(--fx-bg-elev-2)',
                              border: isLast
                                ? '2px solid rgba(16,116,254,0.85)'
                                : '2px solid rgba(16,116,254,0.55)',
                              color: isLast ? '#1a1408' : 'var(--fx-gold-light)',
                              boxShadow: isLast ? '0 0 14px rgba(16,116,254,0.6)' : 'none',
                            }}
                          >
                            {lv.tier}
                          </div>
