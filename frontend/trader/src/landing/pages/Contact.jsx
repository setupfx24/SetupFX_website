...
const Contact = () => {
  ...
  const [messages, setMessages] = useState([
    { from: 'agent', text: 'Hi there! 👋 I\'m Sarah from SetupFX Support. How can I help you today?', time: 'now' }
  ])
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email Us',
      content: 'support@setupfx24.com',
      link: 'mailto:support@setupfx24.com'
    },
    {
      icon: Phone,
      title: 'Call Us',
            ...
            <ScrollReveal variant="fadeRight" delay={0.2}>
              <div>
                ...
                <Card className="p-8 mb-6">
                  <h3 className="text-xl font-semibold text-white mb-4">SetupFX Ltd</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-text-secondary">
                      <span className="text-white font-semibold">Email:</span> support@setupfx24.com
                    </p>
                    <p className="text-text-secondary">
