...
const Commodities = () => {
  const data = {
    ...
    about: {
      ...
      description: 'Commodities offer excellent diversification opportunities and act as a hedge against inflation. Trade precious metals like gold and silver, energy commodities like crude oil and natural gas, and agricultural products with SwissCresta. Benefit from competitive spreads, flexible leverage, and access to global commodity markets 23 hours a day.'
    },
    instruments: [
