        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <ScrollReveal variant="fadeRight" delay={0.2}>
            <div className="inline-flex items-center gap-2 mb-5">
              ...
              <span className="text-primary-accent text-xs font-bold uppercase tracking-[0.2em]">About SetupFX</span>
              <div className="w-5 h-px bg-primary-accent" />
            </div>
            ...
            <div className="space-y-4 mb-8">
              <p className="text-text-secondary leading-relaxed">
                SetupFX was founded with a clear vision — to give traders around the world access to professional-grade trading infrastructure, transparent pricing, and reliable support.
              </p>
              <p className="text-text-secondary leading-relaxed">
              ...
              <p className="text-text-secondary leading-relaxed">
                From beginners entering financial markets to professional algorithmic traders, SetupFX provides the tools, speed, and reliability needed to trade with confidence in global markets.
              </p>
            </div>
