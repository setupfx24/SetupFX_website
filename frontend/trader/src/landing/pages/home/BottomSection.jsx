      ...
      <section className="section-padding bg-primary-secondary relative overflow-hidden">
        <div className="container-custom relative z-10">
          <SectionHeader
            ...
            subtitle="Find answers to the most common questions about trading with SetupFX."
          />
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <ScrollReveal variant="fadeIn" delay={0.2}>
            <p className="text-text-secondary text-lg mb-8 max-w-xl mx-auto">
              Join thousands of traders who trust SetupFX for professional-grade execution, transparent pricing, and competitive conditions.
            </p>
          </ScrollReveal>
          ...
          <div className="flex items-center justify-center gap-3 mt-12 opacity-30">
            ...
            <div className="text-primary-accent text-sm font-semibold">SetupFX</div>
            <div className="w-16 h-px bg-primary-accent" />
          </div>
        </div>
      </section>
