  ...
  return (
    <DashboardShell>
      <div className="page-main max-w-6xl mx-auto w-full pb-8">
        <Link
          href="/academy"
          className="inline-flex items-center gap-1.5 text-sm text-text-secondary hover:text-[#6366F1] transition-colors mb-5"
        >
          <ArrowLeft size={14} />
          ALL PHASES
        </Link>
                    ...
                    >
                      <div
                        className={clsx(
                          ...
                          isDone ? 'bg-[#6366F1]/10 border-[#6366F1] text-[#6366F1]' : 'border-border-secondary text-text-tertiary',
                        )}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {isDone && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#6366F1]/10 text-[#6366F1] font-bold border border-[#6366F1]/20 uppercase tracking-wider">
                              DONE
                            </span>
                          )}
                        </div>
                      ...
                      <ArrowRight size={16} className="text-text-tertiary group-hover:text-[#6366F1] transition-colors shrink-0" />
                    </Link>
        ...
        {phase.quiz && phase.modules.length > 0 && (
          <div className="mt-6 bg-bg-secondary border border-[#6366F1]/20 rounded-xl p-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <Link
                ...
                className="px-4 py-2 rounded-lg bg-[#6366F1] hover:bg-[#4F46E5] text-white text-sm font-semibold transition-colors text-center whitespace-nowrap"
              >
                Start Quiz
              </Link>
            </div>
