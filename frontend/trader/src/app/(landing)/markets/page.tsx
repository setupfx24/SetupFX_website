...
export const metadata = { title: 'Markets — SwissCresta' }
...
const MARKETS = [
  ...
  },
  {
    ...
    icon: Bitcoin,
    title: 'Crypto',
    body: '52 cryptocurrencies on the SwissCresta-developed SQX exchange. Trade 24/7 with Swiss-grade security.',
  },
]
