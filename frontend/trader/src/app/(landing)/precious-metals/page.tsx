...
export const metadata = { title: 'Precious Metals — SetupFX' }
    ...
    <div className="bg-white text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl md:text-5xl lg:text-6xl font-extrabold uppercase tracking-tight leading-[1.05]">
              Gold. Silver.<br />
              <span className="text-[#1074FE]">Timeless.</span>
            </h1>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <Coins className="relative w-32 h-32 md:w-44 md:h-44 text-[#1074FE]" strokeWidth={1.25} />
          </div>
        </div>
      </section>
              ...
              <tbody>
                {METALS.map((m) => (
                  <tr key={m.symbol} className="border-t border-gray-200 hover:bg-gray-50/60">
                    ...
                    <td className="px-5 py-4 font-mono text-[#1074FE] font-semibold">{m.spread}</td>
      ...
      <section className="bg-white py-16">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold uppercase tracking-tight">
            Ready to add metals to your <span className="text-[#1074FE]">portfolio?</span>
          </h2>
