  ...
  return (
    <main className="min-h-screen bg-background">
      <BannerPlaceholder
        ...
        tagline="Refer traders to SetupFX and earn lifetime per-lot commissions — up to $15 per standard lot, paid instantly."
      />
            ...
            <table className="w-full" style={{ borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th className="px-5 py-4 text-center font-display uppercase tracking-[0.16em] text-sm text-white border-r border-white/10" style={{ background: 'linear-gradient(180deg, #1074FE 0%, #1a3210 100%)' }}>21 – 100</th>
      ...
      <section id="benefits" className="mx-auto max-w-[1200px] px-[var(--gutter)] py-12 sm:py-16">
        <div className="text-center mb-10">
          <h2 className="font-display uppercase text-2xl sm:text-3xl md:text-4xl tracking-tight">Why Partner With SetupFX</h2>
        </div>
        ...
        <div className="liquid-glass-strong rounded-3xl p-6 sm:p-10 grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <div className="mt-6 space-y-2 text-xs text-foreground/55">
              <div>📧 partners@setupfx24.com</div>
          ...
          {[
            ...
            <article key={t.name} className="liquid-glass rounded-2xl p-6">
              ...
              <img
                ...
                aria-hidden
                style={{ border: '1px solid rgba(16,116,254,0.35)' }}
              />
