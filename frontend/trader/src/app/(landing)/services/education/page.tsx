  ...
  return (
    <main className="min-h-screen bg-background">
      <BannerPlaceholder
        ...
        tagline="Beginner to advanced — a structured trading curriculum built by professional traders. Free with every SetupFX account."
      />
      ...
      <section className="mx-auto max-w-[1200px] px-[var(--gutter)] py-12 sm:py-16">
        <div className="text-center mb-10">
          <h2 className="font-display uppercase text-2xl sm:text-3xl md:text-4xl tracking-tight">Why Train With SetupFX</h2>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            { icon: Award,         title: 'Earn a Certificate',       body: 'Finish a track and pass the assessment to receive a SetupFX Academy certificate of completion.' },
            ...
            { icon: Video,         title: 'Practical Demos',          body: 'Every concept is shown live on the SetupFX platform — no abstract theory, all chart and order ticket.' },
            { icon: Users,         title: 'Community Discord',        body: 'Discuss setups, share journals, and learn from peers. Moderated by the analyst desk.' },
            { icon: BookOpen,      title: 'Always Free',              body: 'No paywalls, no upgrades, no upsells. Every funded SetupFX account unlocks the full library.' },
      ...
      <section id="faq" className="mx-auto max-w-[800px] px-[var(--gutter)] py-12 sm:py-16">
        ...
        <div className="space-y-3">
          <FaqItem q="Is the Academy really free?">
            Yes. The full library — videos, PDFs, blogs, webinars — is included with every SetupFX account. No
