    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative w-full overflow-hidden" style={{ minHeight: 'min(560px, 75vh)' }}>
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(135deg, hsl(217 99% 53% / 0.18) 0%, hsl(0 0% 6%) 60%, hsl(0 100% 41% / 0.10) 100%)',
          }}
        />
        <div
          aria-hidden
        ...
        <div className="relative z-10 mx-auto max-w-[1200px] px-[var(--gutter)] pt-32 pb-16 sm:pt-44 sm:pb-24 text-center">
          ...
          <p className="mt-6 mx-auto max-w-2xl text-foreground/70 text-sm sm:text-base md:text-lg leading-relaxed">
            Early access to promising blockchain projects, vetted by SetupFX before they hit the wider market.
      ...
      <section className="mx-auto max-w-[1200px] px-[var(--gutter)] py-12 sm:py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            { icon: Users,    title: 'Early-Access Tiers',     body: 'Loyalty-based allocation tiers. Active SetupFX traders get priority access and higher allocation caps.' },
            { icon: Gem,      title: 'Discounted Entry',       body: 'Strategic-round pricing for SetupFX investors — below public-sale rates, with vesting to align incentives.' },
      ...
      <section className="mx-auto max-w-[1200px] px-[var(--gutter)] pb-20">
        <div className="liquid-glass-strong rounded-3xl p-8 sm:p-12 text-center">
          ...
          <p className="mt-4 text-foreground/70 max-w-xl mx-auto text-sm sm:text-base">
            Open a SetupFX account today — every trade you place between now and launch counts toward your
            early-access tier.
          </p>
