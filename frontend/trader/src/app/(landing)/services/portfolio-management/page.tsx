            ...
            <table className="w-full" style={{ borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th className="px-5 py-4 text-center font-display uppercase tracking-[0.16em] text-sm text-white" style={{ background: 'linear-gradient(180deg, #1074FE 0%, #1a3210 100%)' }}>MAM</th>
                </tr>
              </thead>
              <tbody>
                {[
      ...
      <section className="mx-auto max-w-[1200px] px-[var(--gutter)] pb-20">
        <div className="liquid-glass-strong rounded-3xl p-8 sm:p-12 text-center">
          ...
          <p className="mt-4 text-foreground/70 max-w-xl mx-auto text-sm sm:text-base">
            Open your SetupFX account, choose MAM or PAMM, and allocate to a verified manager in under 24 hours.
          </p>
