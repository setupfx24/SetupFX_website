              ...
              return (
                <button
                  ...
                  className={clsx(
                    ...
                    active ? 'text-accent' : 'text-[#6B7280] hover:text-[#0A0A0A]',
                  )}
                >
    ...
    return (
      <div className="space-y-5">
        ...
        <div className="rounded-2xl border border-[#E5E5E5] bg-white p-5">
          ...
          <div className="flex items-center gap-3">
            <span className="rounded-lg bg-[#F5F5F5] px-4 py-2.5 text-lg font-bold font-mono text-accent">
      ...
      extra={(
        <div className="text-left">
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#E5E5E5] bg-white px-4 py-2.5 text-sm text-[#0A0A0A] placeholder:text-[#9CA3AF] outline-none focus:border-accent focus:ring-2 focus:ring-accent/15"
          />
        </div>
      )}
    />
