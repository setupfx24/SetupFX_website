      ...
      <div className="page-main space-y-4 sm:space-y-6 text-text-primary">
        ...
        {invalidAccountParam ? (
          <div className="rounded-xl border border-amber-500/35 bg-amber-500/10 px-4 py-3 text-sm text-text-primary">
            ...
            <Link href="/portfolio" className="font-semibold text-[#6366F1] underline underline-offset-2 hover:text-[#4F46E5]">
              Reset
            </Link>
          </div>
        ) : null}
        ...
        {validAccountId ? (
          <div className="rounded-xl border border-[#6366F1]/30 bg-[#6366F1]/10 px-4 py-3 flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-wider text-[#6366F1]">Account scope</p>
            ...
            <Link
              href="/portfolio"
              className="text-xs font-semibold text-[#6366F1] hover:text-[#4F46E5] underline underline-offset-2 shrink-0"
            >
              View all accounts
            </Link>
          </div>
                  ...
                  return nums.map((n) => (
                    <button
                      ...
                      className={clsx(
                        ...
                        n === page
                          ? 'bg-[#6366F1] text-text-inverse border-[#6366F1]'
