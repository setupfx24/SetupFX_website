...
const STEPS = [
  ...
  { n: 3, title: 'Trade',    body: "Access the world's largest markets directly from your SetupFX account." },
];
      ...
      >
        <div className="flex flex-col items-start gap-5 mb-10 sm:mb-14 md:mb-20">
          ...
          <p className="font-body text-foreground/60 max-w-2xl text-sm sm:text-base">
            SetupFX is a leading AI-driven cryptocurrency and forex investment company. From sign-up to first profit in three simple steps — whether you are a first-time investor or a seasoned trader.
          </p>
        </div>
