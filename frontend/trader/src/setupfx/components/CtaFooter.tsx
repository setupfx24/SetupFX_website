  ...
  return (
    <section id="cta" className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(60% 50% at 50% 50%, rgba(16,116,254,0.12) 0%, rgba(0,0,0,0.7) 60%, #000 100%)',
        }}
        aria-hidden
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-8 mb-12">
            <div className="lg:col-span-2 flex flex-col gap-4">
              ...
              <p className="font-body text-sm text-foreground/65 max-w-sm leading-relaxed">
                SetupFX is an institutional-grade forex, CFD broker, and decentralized exchange built for serious traders. It offers fast execution, low spreads, transparent pricing, insured trades, and fully automated trading with no human intervention.
              </p>
              <p className="font-body text-sm text-foreground/65 max-w-sm leading-relaxed">
                SetupFX also provides staking with fixed monthly income, anytime withdrawals, and a rewarding IB (Introducing Broker) program with profit-sharing opportunities for partners and affiliates.
              </p>
              <div className="flex items-center gap-3 mt-2">
                {[
                  { Icon: Facebook,  label: 'Facebook',  href: 'https://www.facebook.com/profile.php?id=61589880747321' },
                  { Icon: Instagram, label: 'Instagram', href: 'https://www.instagram.com/setupfx/' },
                  { Icon: Linkedin,  label: 'LinkedIn',  href: 'https://www.linkedin.com/in/swis-dex-a62208410/' },
                  { Icon: Youtube,   label: 'YouTube',   href: 'https://youtube.com/@setupfx-u7q' },
                ].map(({ Icon, label, href }) => (
                  <a
                    key={label}
                    href={href}
            ...
            <div className="flex flex-col gap-3">
              ...
              <span className="font-body text-sm text-foreground/70">support@setupfx24.com</span>
              <span className="font-body text-sm text-foreground/70 leading-relaxed">
                SetupFX Office 23US,<br />
