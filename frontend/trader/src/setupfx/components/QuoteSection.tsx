  ...
  return (
    <section className="relative px-3 sm:px-6 py-10 sm:py-16 md:py-20">
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, hsl(217 75% 18%) 0%, hsl(0 0% 8%) 55%, hsl(0 60% 14%) 100%)',
      ...
      >
        ...
        <div
          ...
          style={{
            border: '1px solid hsl(217 99% 53% / 0.25)',
            background:
              'radial-gradient(circle at 50% 50%, hsl(217 99% 53% / 0.08) 0%, transparent 60%)',
          }}
        />
        <div
          aria-hidden
          className="absolute -right-44 top-12 size-[300px] rounded-full pointer-events-none hidden md:block"
          style={{ border: '1px solid hsl(217 99% 53% / 0.18)' }}
        />
            ...
            <div
              ...
              style={{
                background: imgErrored
                  ? 'linear-gradient(135deg, hsl(217 99% 53% / 0.25) 0%, hsl(0 0% 8%) 100%)'
                  : 'transparent',
                color: 'hsl(217 95% 78%)',
                border: '1px solid hsl(217 99% 53% / 0.4)',
