...
const RULES: { keys: string[]; reply: string; cta?: { label: string; href: string }[] }[] = [
  {
    ...
    reply:
      "Hi! 👋 I'm SwisBot, your SetupFX assistant. I can help with account types, deposits, the welcome bonus, fixed-return plans, our DEX, insurance, IB program, and more. What would you like to know?",
  },
  {
  ...
  },
  {
    ...
    reply:
      'SetupFX DEX lets you trade directly from your own wallet — non-custodial, on-chain execution. Keep your private keys, sign trades, settle through smart contracts in seconds. MetaMask, WalletConnect, and EVM wallets all work.',
    cta: [{ label: 'How it works', href: '/how-it-works' }],
  },
  {
    keys: ['insurance', 'insured', 'insure', 'trade protection', 'protect my trade'],
    reply:
      'Every position on SetupFX is automatically policy-backed by on-chain trade insurance — no opt-in. If the market moves against you beyond the policy threshold, the insured amount pays out automatically via smart contract.',
  ...
  },
  {
    ...
    reply:
      'SetupFX runs on a fast web platform plus dedicated iOS and Android apps. All platforms sync to one account — positions, alerts, and watchlists stay in sync across every device.',
  ...
  },
  {
    ...
    cta: [
      ...
      { label: 'Email us',         href: 'mailto:support@setupfx24.com' },
    ],
  },
  {
  ...
  },
  {
    ...
    reply:
      'SetupFX is a globally regulated forex & CFD broker founded in 2010, with a decentralized exchange layer added. Client funds are held in segregated tier-one bank accounts; trades carry on-chain insurance.',
  },
  {
      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            style={{
              background: 'linear-gradient(135deg, hsl(217 99% 53%) 0%, hsl(217 95% 32%) 100%)',
              boxShadow: '0 8px 28px rgba(16,116,254,0.45), 0 0 0 4px rgba(16,116,254,0.15)',
            }}
          >
            ...
            <span
              ...
              style={{ background: 'hsl(217 99% 53% / 0.4)' }}
            />
          </motion.button>
        )}
      </AnimatePresence>
        ...
        {open && (
          <motion.div
            ...
            style={{
              ...
              border: '1px solid hsl(217 99% 53% / 0.35)',
              boxShadow: '0 20px 60px rgba(0,0,0,0.6), 0 0 0 1px rgba(16,116,254,0.08)',
            }}
            role="dialog"
          ...
          >
            ...
            <div
              ...
              style={{ background: 'linear-gradient(135deg, hsl(217 99% 53% / 0.18) 0%, hsl(0 0% 7%) 100%)' }}
            >
              <div className="size-9 rounded-full flex items-center justify-center" style={{ background: 'hsl(217 99% 53% / 0.3)' }}>
              ...
              <>
                  ...
                  <div className="px-4 pb-2 flex flex-wrap gap-2" style={{ background: 'hsl(0 0% 5%)' }}>
                    {QUICK_REPLIES.map((q) => (
                      <button
                        ...
                        style={{
                          color: '#ffffff',
                          background: 'hsl(217 99% 53% / 0.22)',
                          border: '1px solid hsl(217 99% 53% / 0.65)',
                        }}
                      >
                        {q}
                      </button>
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, hsl(217 99% 53%) 0%, hsl(217 95% 32%) 100%)',
                    }}
                  >
  ...
  return (
    <div className={`flex items-end gap-2 ${isUser ? 'flex-row-reverse' : ''}`}>
      <div
        ...
        style={{ background: isUser ? 'hsl(217 99% 53% / 0.25)' : 'hsl(0 0% 14%)' }}
      >
      ...
      <div className={`flex flex-col gap-1.5 max-w-[78%] ${isUser ? 'items-end' : 'items-start'}`}>
        <div
          ...
          style={{
            background: isUser ? 'hsl(217 99% 53% / 0.28)' : 'hsl(0 0% 16%)',
            color: '#ffffff',
            border: isUser ? '1px solid hsl(217 99% 53% / 0.5)' : '1px solid hsl(0 0% 22%)',
          }}
        >
          {m.text}
        </div>
