      ...
      <div className="relative" style={{ width: size, height: size }}>
        <svg width={size} height={size} className="rotate-[-90deg]">
          ...
          <circle
            ...
            className="drop-shadow-[0_0_6px_rgba(99,102,241,0.45)]"
          />
        </svg>
  ...
  return (
    <section className="text-text-primary">
      <div className="flex items-center gap-2 mb-4">
        <div className="w-10 h-10 rounded-xl bg-[#6366F1]/12 border border-[#6366F1]/25 flex items-center justify-center">
        ...
        {[
          {
            ...
            valueClass: j.netPl >= 0 ? 'text-[#6366F1]' : 'text-red-400',
